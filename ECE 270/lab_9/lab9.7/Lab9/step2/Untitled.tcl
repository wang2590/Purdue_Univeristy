...
########## Tcl recorder starts at 03/20/17 19:21:15 ##########

set version "1.7"
set proj_dir "U:/Personal/ECE 270/Lab9/step2"
cd $proj_dir
...
# Hierarchy
if [runCmd "\"$cpld_bin/ahdl2blf\" step2.abl -ojhd only -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 03/20/17 19:21:15 ###########


########## Tcl recorder starts at 03/20/17 19:21:34 ##########
...
########## Tcl recorder end at 03/20/17 19:21:34 ###########


########## Tcl recorder starts at 03/20/17 19:21:42 ##########
...
if [runCmd "\"$cpld_bin/mblflink\" \"step2.bl1\" -o \"untitled.bl2\" -omod \"untitled\"  -err \"automake.err\""] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/prefit\" -blif -inp untitled.bl4 -out untitled.bl5 -err automake.err -log untitled.log -mod step2 @untitled.l0  -sc"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/tda\" -i untitled.bl5 -o untitled.tda -lci untitled.lct -dev m4e_256_96 -family lc4k -mod step2 -ovec NoInput.tmv -err tda.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 03/20/17 19:21:42 ###########


########## Tcl recorder starts at 03/20/17 19:24:57 ##########
...
########## Tcl recorder end at 03/20/17 19:24:57 ###########


########## Tcl recorder starts at 03/20/17 19:25:04 ##########
...
########## Tcl recorder end at 03/20/17 19:25:04 ###########


########## Tcl recorder starts at 03/20/17 19:25:13 ##########
...
########## Tcl recorder end at 03/20/17 19:25:13 ###########


########## Tcl recorder starts at 03/20/17 19:25:14 ##########
...
########## Tcl recorder end at 03/20/17 19:25:14 ###########


########## Tcl recorder starts at 03/20/17 19:26:35 ##########
...
########## Tcl recorder end at 03/20/17 19:26:35 ###########


########## Tcl recorder starts at 03/20/17 19:26:45 ##########
...
########## Tcl recorder end at 03/20/17 19:26:45 ###########
