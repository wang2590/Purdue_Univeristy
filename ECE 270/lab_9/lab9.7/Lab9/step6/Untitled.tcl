...
########## Tcl recorder starts at 03/20/17 20:51:32 ##########

set version "1.7"
set proj_dir "U:/Personal/ECE 270/Lab9/step6"
cd $proj_dir
...
# Hierarchy
if [runCmd "\"$cpld_bin/ahdl2blf\" step6.abl -ojhd only -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 03/20/17 20:51:32 ###########


########## Tcl recorder starts at 03/20/17 20:55:30 ##########
...
########## Tcl recorder end at 03/20/17 20:55:30 ###########


########## Tcl recorder starts at 03/20/17 20:55:34 ##########
...
# Commands to make the Process: 
# Fit Design
if [runCmd "\"$cpld_bin/ahdl2blf\" step6.abl -mod step6 -ojhd compile -ret -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/mblifopt\" step6.bl0 -collapse none -reduce none -err automake.err  -keepwires"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/mblflink\" \"step6.bl1\" -o \"untitled.bl2\" -omod \"untitled\"  -err \"automake.err\""] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/prefit\" -blif -inp untitled.bl4 -out untitled.bl5 -err automake.err -log untitled.log -mod step6 @untitled.l0  -sc"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/tda\" -i untitled.bl5 -o untitled.tda -lci untitled.lct -dev m4e_256_96 -family lc4k -mod step6 -ovec NoInput.tmv -err tda.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 03/20/17 20:55:34 ###########


########## Tcl recorder starts at 03/20/17 21:07:19 ##########
...
########## Tcl recorder end at 03/20/17 21:07:19 ###########


########## Tcl recorder starts at 03/20/17 21:07:22 ##########
...
########## Tcl recorder end at 03/20/17 21:07:22 ###########
