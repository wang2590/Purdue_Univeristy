...
########## Tcl recorder starts at 03/20/17 19:58:08 ##########

set version "1.7"
set proj_dir "U:/Personal/ECE 270/Lab9/step5"
cd $proj_dir
...
########## Tcl recorder end at 03/20/17 19:58:08 ###########


########## Tcl recorder starts at 03/20/17 20:27:01 ##########
...
########## Tcl recorder end at 03/20/17 20:27:01 ###########


########## Tcl recorder starts at 03/20/17 20:27:06 ##########
...
if [runCmd "\"$cpld_bin/mblifopt\" step5.bl0 -collapse none -reduce none -err automake.err  -keepwires"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/mblflink\" \"step5.bl1\" -o \"untitled.bl2\" -omod \"untitled\"  -err \"automake.err\""] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/prefit\" -blif -inp untitled.bl4 -out untitled.bl5 -err automake.err -log untitled.log -mod step5 @untitled.l0  -sc"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/tda\" -i untitled.bl5 -o untitled.tda -lci untitled.lct -dev m4e_256_96 -family lc4k -mod step5 -ovec NoInput.tmv -err tda.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 03/20/17 20:27:06 ###########


########## Tcl recorder starts at 03/20/17 21:06:35 ##########
...
########## Tcl recorder end at 03/20/17 21:06:35 ###########


########## Tcl recorder starts at 03/20/17 21:06:38 ##########
...
########## Tcl recorder end at 03/20/17 21:06:38 ###########
