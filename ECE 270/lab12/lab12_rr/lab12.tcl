...
########## Tcl recorder starts at 04/14/17 12:44:40 ##########
...
# Hierarchy
if [runCmd "\"$cpld_bin/ahdl2blf\" lab12_3.abl -ojhd only -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 04/14/17 12:44:40 ###########


########## Tcl recorder starts at 04/14/17 13:04:56 ##########
...
########## Tcl recorder end at 04/14/17 13:04:56 ###########


########## Tcl recorder starts at 04/14/17 13:05:00 ##########
...
# Commands to make the Process: 
# Fit Design
if [runCmd "\"$cpld_bin/ahdl2blf\" lab12_3.abl -mod lab12 -ojhd compile -ret -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 04/14/17 13:05:00 ###########


########## Tcl recorder starts at 04/14/17 13:27:32 ##########
...
########## Tcl recorder end at 04/14/17 13:27:32 ###########
