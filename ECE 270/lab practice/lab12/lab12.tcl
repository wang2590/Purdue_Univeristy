...
########## Tcl recorder starts at 04/25/17 19:16:25 ##########

set version "1.7"
set proj_dir "U:/ECE 270/lab practice/lab12"
cd $proj_dir
...
########## Tcl recorder end at 04/25/17 19:16:25 ###########


########## Tcl recorder starts at 04/25/17 19:18:16 ##########
...
########## Tcl recorder end at 04/25/17 19:18:16 ###########


########## Tcl recorder starts at 04/25/17 19:18:21 ##########
...
if [runCmd "\"$cpld_bin/mblflink\" \"isp4256ZEio.bl1\" -o \"lab12.bl2\" -omod \"lab12\"  -err \"automake.err\""] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/prefit\" -blif -inp lab12.bl4 -out lab12.bl5 -err automake.err -log lab12.log -mod isp4256ZEio @lab12.l0  -sc"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
if [runCmd "\"$cpld_bin/tda\" -i lab12.bl5 -o lab12.tda -lci lab12.lct -dev m4e_256_96 -family lc4k -mod isp4256ZEio -ovec NoInput.tmv -err tda.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 04/25/17 19:18:21 ###########


########## Tcl recorder starts at 04/25/17 19:18:29 ##########
...
########## Tcl recorder end at 04/25/17 19:18:29 ###########


########## Tcl recorder starts at 04/25/17 19:20:00 ##########
...
########## Tcl recorder end at 04/25/17 19:20:00 ###########


########## Tcl recorder starts at 04/25/17 19:20:02 ##########
...
########## Tcl recorder end at 04/25/17 19:20:02 ###########
